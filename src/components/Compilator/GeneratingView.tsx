...
export const GeneratingView: React.FC = () => {
  ...
  const stages = [
    'Calculando volumen efectivo por grupo muscular...',
    'Alineando patrones biomecánicos y curvas de resistencia...',
    'Asignando tiempos de recuperación y proximidad al fallo (RIR)...',
    'Finalizando arquitectura del protocolo de entrenamiento...'
  ];
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-24 flex flex-col items-center justify-center text-center min-h-[calc(100vh-140px)]">
      <div className="w-full space-y-6">
        {/* Austere Minimalist Circular Indicator */}
